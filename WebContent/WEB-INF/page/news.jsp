...
<html class="no-js" lang="">
    <head>
        ...
        <c:set var="title" value="“${key }” :搜索结果"></c:set>
    ...
    <body>
        ...
        <![endif]-->
             ...
             <div class="abad" style="width: 1060px; height: 100px; margin: auto;">
                      <!-- 广告位 -->
					<a:output code="newspage_1" descript="资讯页面头部广告位" height="100"
						width="1060" href="#" />
             </div>
            <!-- 广告位结束 -->
        ...
        <div id="main" class="container nohome">
            ...
            <div class="row bgwhite">
                ...
                <!-- 资讯列表开始 -->
                    ...
                    <!-- 隐藏表单 -->
					<form action="${key!=null?'searchArtical.html':'toNews.html' }" method="post" id="newsForm">
                           ...
                           <!-- 一周热文结束 -->
                             ...
                             <!-- 广告位开始 -->
                              <div class="abad" style="width: 100%; height: 250px; ">
                                		<a:output code="newspage_2" descript="资讯页面中部右边广告位" height="250"
						width="296" href="#" />
                                </div>
                            <!-- 广告位结束 -->
                        </div>
            ...
            <div class="row bgwhite">
                     ...
                     <div class="abad" style="width: 100%; height: 100px;  margin-bottom: 30px;">
                           <!-- 广告位 -->
					<a:output code="newspage_3" descript="资讯页面底部广告位" height="100"
						width="1060" href="#" />
                    </div>
                    <!-- 广告位结束 -->   
            </div>
