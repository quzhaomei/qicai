				...
				<div class="row-fluid sortable">
					<div class="box span12">
						<div class="box-header" data-original-title>
							...
							<div class="box-icon">
							<ad:power uri="../zcarSale/add.html">
										...
										<tr>
											...
											<ad:power uri="../zcarSale/update.html">	
												...
												<ad:power uri="../zcarSale/toTop.html">
												 ...
												 <ad:power uri="../zcarSale/delete.html">
												 <label
