				...
				<div class="row-fluid sortable">
					<div class="box span12">
						<div class="box-header" data-original-title>
							...
							<div class="box-icon">
							<ad:power uri="../zcarData/add.html">
										...
										<tr>
											...
											<ad:power uri="../zcarData/update.html">	
												...
												<ad:power uri="../zcarData/toTop.html">
												 ...
												 <ad:power uri="../zcarData/delete.html">
												 <label
