				...
				<div class="row-fluid sortable">
					<div class="box span12">
						<div class="box-header" data-original-title>
							...
							<div class="box-icon">
							<ad:power uri="../zcarVideo/add.html">
										...
										<tr>
											...
											<ad:power uri="../zcarVideo/update.html">	
												...
												<ad:power uri="../zcarVideo/toTop.html">
												 ...
												 <ad:power uri="../zcarVideo/delete.html">
												 <label
