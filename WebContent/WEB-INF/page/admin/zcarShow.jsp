				...
				<div class="row-fluid sortable">
					<div class="box span12">
						<div class="box-header" data-original-title>
							...
							<div class="box-icon">
							<ad:power uri="../zcarShow/add.html">
										...
										<tr>
											...
											<ad:power uri="../zcarShow/update.html">	
												...
												<ad:power uri="../zcarShow/toTop.html">
												 ...
												 <ad:power uri="../zcarShow/delete.html">
												 <label
