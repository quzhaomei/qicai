								...
								<form class="form-horizontal">
									<fieldset>
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="name" class="span6 typeahead"
													...
													<input type="hidden" id="peopleId"  value="${people.peopleId }" readonly="readonly"/>
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="ename" class="span6 typeahead" value="${people.ename }"
													maxlength="50" placeholder="请输入英文名字" readonly="readonly"/> 
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="nationality" class="span6 typeahead" value="${people.nationality }"
													maxlength="50" placeholder="请输入国籍" readonly="readonly"/> 
											</div>
										</div>
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="birthPlace" class="span6 typeahead" value="${people.birthPlace }"
													maxlength="50" placeholder="请输入出生地" readonly="readonly"/> 
											</div>
										</div>
										<div class="control-group">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="job" placeholder="请输入职业" readonly="readonly" value="${people.job }" /> 
											</div>
										</div>
