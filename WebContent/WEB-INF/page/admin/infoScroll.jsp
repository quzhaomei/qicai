...
<body>
			...
			<div id="content" class="span10">
				...
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2>
								<i class="halflings-icon user"></i><span class="break"></span>首页资讯广告轮播管理
							</h2>
							<div class="box-icon">
							<ad:power uri="../infoScroll/add.html">
	...
	<!-- end: JavaScript-->
	<script type="text/javascript" src="../js/admin/infoScroll.js" charset="utf-8"></script>
</body>
<!-- 新增modal -->
		...
		<div class="modal-body">
			<p><small class="text-success">新建轮播</small></p>
				<table style="width:100%;">
					...
					<td>
						<input class="input-large span5" id="add_title"  type="text" placeholder="请输入滚动标题" maxlength="16" >
					</td>
					</tr>
					<tr>
						<td>
					...
					<td>
						<input class="input-large span5" id="add_href"  type="text" placeholder="请输入滚动标题" maxlength="50" >
					</td>
					</tr>
					</table>
		</div>
			...
			<p><small class="text-success">修改轮播</small></p>			
					...
					<td>
						<input class="input-large span5" id="edit_title" 
						 type="text" placeholder="请输入标题" maxlength="16" >
					</td>
					</tr>
					<tr>
					<tr>
					...
					<td>
						<input class="input-large span5" id="edit_href"  type="text"
						 placeholder="请输入链接" maxlength="50" >
					</td>
					</tr>
					</table>
		</div>
