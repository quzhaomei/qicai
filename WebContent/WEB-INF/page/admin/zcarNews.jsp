				...
				<div class="row-fluid sortable">
					<div class="box span12">
						<div class="box-header" data-original-title>
							...
							<div class="box-icon">
							<ad:power uri="../zcarNews/add.html">
										...
										<tr>
											...
											<ad:power uri="../zcarNews/update.html">	
												...
												<ad:power uri="../zcarNews/toTop.html">
												 ...
												 <ad:power uri="../zcarNews/delete.html">
												 <label
