...
<body>
			...
			<div id="content" class="span10">
				<ul class="breadcrumb">
					<li><i class="icon-home"></i> <a href="index.html">首页</a></li>
				 	<li><a href="#">门户菜单管理<i class="icon-angle-right"></i> </a> 
					</li>
				</ul>

				<div class="tree well">
				<h2>
					门户菜单管理 <small style="font-size:12px;color:#888;"> <i
	...
	<!-- end: JavaScript-->
	<script type="text/javascript" src="../js/admin/zcarMenu.js"></script>
	...
	<form action="#" id="validateForm">
		...
		<div id="myTabContent" class="tab-content">
			...
			<div class="tab-pane fade in active text-left" id="edit">
				...
				<div class="input-prepend" title="位置">
					<span class="add-on"><i class="halflings-icon globe"></i> 位
					置 </span> <input class="input-large span5" id="edit_position" name="position" type="text"
						style="ime-mode:disabled" placeholder="请输入菜单显示顺序" maxlength="2" />
				</div>
			</div>
			<!-- 删除tab -->
			...
			<div class="tab-pane fade  text-left" id="add">
				...
				<div class="input-prepend" title="位置">
					<span class="add-on"><i class="halflings-icon globe"></i> 位
					置 </span> <input class="input-large span5" id="add_position" name="add_position" type="text"
						style="ime-mode:disabled" placeholder="请输入菜单显示顺序" maxlength="2" />
				</div>
			</div>
		</div>
